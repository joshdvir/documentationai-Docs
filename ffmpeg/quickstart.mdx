...
<Steps>
  <Step title="Create Account" icon="user-plus" title-type="p">
    Visit <a href="https://app.fetchmedia.io" target="_blank" rel="noopener noreferrer">[https://app.fetchmedia.io](https://app.fetchmedia.io)</a> and sign up with your email.
  </Step>
  ...
  <Step title="Poll for Results" icon="git-pull-request" title-type="p">
    ...
    <CodeGroup show-lines="true" tabs={["python"]}>
      ```javascript
      // Poll example
...
<Callout kind="success" collapsed="false">
  Congratulations! You've processed your first video with the Commands API. Check your dashboard at <a href="https://app.fetchmedia.io" target="_blank" rel="noopener noreferrer">[https://app.fetchmedia.io](https://app.fetchmedia.io)</a> for usage stats.
</Callout>
