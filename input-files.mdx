...
- `"in_4"`: Represents an existing input file within Fetchmedia, identified by the `download_url`. This allows you to reuse previously uploaded or processed files directly.
...
```json
{
  "input_files": {
    ...
    "in_4": "https://api.fetchmedia.io/v1/files/123e4567-e89b-12d3-a456-426614174000/file.mp4",
  },
  "output_files": {
    "out_1": "output.mp4"
  },
