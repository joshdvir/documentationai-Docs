...
<Steps>
  <Step title="Create Account" icon="user-plus" title-type="p">
    Visit [<a href="https://app.fetchmedia.io" target="_blank" rel="noopener noreferrer">https://app.fetchmedia.io</a>](https://app.fetchmedia.io) and sign up with your email.
  </Step>
